...
// Mengubah buffer menjadi string Base64 (agar bisa dikirim sebagai JSON)
...
// Mengubah string Base64 kembali menjadi buffer
...
// --- FUNGSI PUBLIK YANG AKAN KITA GUNAKAN ---
...
export const getOrGenerateKeys = async (token) => {
  ...
  try {
    // --- 2. TAMBAHKAN BLOK UPLOAD DI SINI ---
    ...
    // Di aplikasi nyata, perlu ada penanganan error yang lebih baik
  }
